  ...
  return (
    <div style={{ width:"100%", height:"100dvh", background:C.bg, display:"flex", flexDirection:"column", overflow:"hidden" }}>
      ...
      <div style={{ flex:1, overflow:"hidden", position:"relative", display:"flex", flexDirection:"column" }}>
        ...
        {view === "pdfViewer"     && (
          <Suspense fallback={<div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:"#f2f2f7"}}>
            <div style={{color:"#6e6e73",fontSize:14}}>불러오는 중...</div>
          </div>}>
        ...
        {view === "live" && (user?.role === "admin" || (isBroadcast(user?.role) && anyLiveActive)) && (
          <Suspense fallback={<div style={{display:"flex",alignItems:"center",justifyContent:"center",height:"100vh",background:"#f2f2f7"}}><div style={{color:"#6e6e73",fontSize:14}}>불러오는 중...</div></div>}>
