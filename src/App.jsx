...
const HELP_ITEMS = [
  ...
  { icon:"bell",      name:"알림",              eng:"Notifications", ini:"ㅇ", desc:"팀 리더가 보낸 알림 목록을 확인합니다. 알림은 번호순(최신이 맨 위)으로 표시되며 예배 일자·타입·내용이 함께 표시됩니다. 읽지 않은 알림 수가 하단 탭 배지에 표시되고, 앱을 열 때 읽지 않은 알림이 있으면 팝업으로 먼저 안내합니다. 항목을 탭하면 읽음 처리됩니다." },
  { icon:"bell",      name:"알림 보내기",       eng:"Send Notification", ini:"ㅇ", desc:"예배 상세 화면의 종(🔔) 버튼으로 팀원 전체에게 알림을 보냅니다. (리더 전용) 알림 타입(예배 악보·참고·공지)을 선택하고 내용을 입력한 뒤 전송합니다. 같은 예배에 여러 번 보낼 수 있으며 전송 횟수가 종 버튼 배지에 표시됩니다. FCM 푸시를 통해 앱이 닫힌 팀원에게도 알림이 전달됩니다." },
