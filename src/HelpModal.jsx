...
export const HELP_ITEMS = [
  ...
  { icon:"pen",       name:"팀 필기",           eng:"Team Annotation",ini:"ㅌ", desc:"리더·어드민이 팀 전체를 위해 남기는 필기입니다. 항상 초록색(#12A150)으로 표시되어 개인 필기와 구분됩니다. 악보 뷰어 상단에 '이 페이지에 팀필기가 있습니다' 배너가 표시되고, 악보 카드에도 초록색 '팀 필기' 배지가 붙습니다. 필기 모드에서 👥 버튼을 켜면 팀 필기 모드로 전환됩니다." },
  // ㅍ
