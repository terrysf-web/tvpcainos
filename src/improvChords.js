...
// ── 분위기별 진행 패턴 (도수 번호 배열, 4마디)
const PROGRESSIONS = {
  major: {
    calm:       [[1, 6, 4, 5], [6, 4, 1, 5], [1, 5, 6, 4], [4, 1, 5, 6]],
    adoration:  [[1, 4, 6, 5], [2, 5, 1, 4], [1, 3, 4, 5], [1, 4, 1, 5]],
    praise:     [[1, 5, 6, 4], [4, 1, 5, 6], [1, 4, 5, 4], [5, 6, 4, 1]],
  },
  minor: {
    calm:       [[1, 6, 3, 7], [1, 4, 6, 5], [1, 3, 7, 6], [6, 7, 1, 1]],
    adoration:  [[1, 4, 5, 1], [1, 6, 7, 1], [1, 4, 7, 3], [1, 5, 6, 3]],
    praise:     [[1, 7, 6, 7], [1, 5, 6, 3], [6, 7, 1, 5], [1, 4, 5, 6]],
  },
};
